...
& \Rightarrow P(A_i\mid B) = \frac{P(B\mid A_i)P(A_i)}{\sum\nolimits_{j}P(B\mid A_j)P(A_j)}\end{align*}
...
$$\mathbf{J} = \frac{d\mathbf{f}}{d\mathbf{x}} = \left[ \frac{\partial \mathbf{f}}{\partial x_1} \cdots \frac{\partial \mathbf{f}}{\partial x_n} \right] = \left[ \begin{matrix}
